...
def instructions():
    ...
    print('''
    Suppose you want to join the points marked as '#' insted of '+'
    ------------------------
       a   b   c   d
    0  #   #   +   +      'a0' denotes the first point shown as '#'
                          'b0' denotes the second point shown as '#'
    1  +   +   +   +
    2  +   +   +   +
    3  +   +   +   +
    ------------------------
    Enter the first point for 1 : a0 ( Player's Entry for the first point )
    Enter the second point for 1 : b0 ( Player's Entry for the second point)
    line created between a0 and b0 ( Computer's prompt )
    ------------------------
        a   b   c   d
     0  +___+   +   +
     1  +   +   +   +
     ...
     3  +   +   +   +
    ------------------------
    Enter the first point for 2 : ( Turn for second player )
    ''')
    print("\n----------------------------------CONFERMATION---------------------------------")
